...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__invoicesettle__ = __webpack_require__(423);
...
var InvoicesettlePage = /** @class */ (function () {
    ...
    InvoicesettlePage.prototype.loadCustomerDetils = function (invoice) {
        var _this = this;
        this.restCall.searchInvoiceHistory(invoice).subscribe(function (res) {
            if (res['success']) {
                this.data = res['data'];
            }
            else {
