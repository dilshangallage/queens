...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__invoice__ = __webpack_require__(425);
...
var InvoicePage = /** @class */ (function () {
    ...
    InvoicePage.prototype.submitInvoice = function () {
        var _self = this;
        this.restCall.saveCustomerDetails(this.pageView.invoiceType, this.pageView.customrtName, this.pageView.customrtMobile, 1, this.pageView.eventDateTime, 0, this.pageView.treatmentId, this.pageView.advance, this.pageView.balance, this.pageView.advance + this.pageView.balance).subscribe(function (res) {
            if (res['success']) {
