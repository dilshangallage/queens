...
var InvoicePage = /** @class */ (function () {
    ...
    InvoicePage.prototype.submitInvoice = function () {
        ...
        // });
        var _this = this;
        this.restCall.saveCustomerDetails(this.invoiceType, this.customerName, this.customerContactNumber, 1, '2020-03-02 17:55:06', this.customerId, 1, 2800, 0, 2800).subscribe(function (res) {
            if (res['success']) {
            }
            else {
                this.submitAlert();
