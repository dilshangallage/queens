...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__invoice__ = __webpack_require__(420);
...
var InvoicePage = /** @class */ (function () {
    ...
    InvoicePage.prototype.submitInvoice = function () {
        var _this = this;
        this.restCall.saveCustomerDetails(this.invoiceType, this.customerName, this.customerContactNumber, this.beauticianId, this.eventDate, this.customerId, this.treatmentId, this.advance, this.balance, this.total).subscribe(function (res) {
            if (res['success']) {
            }
            else {
                this.submitAlert();
